...
const ResetPassword = () => {
  ...
  const handleSubmit = async (e) => {
    ...
    try {
      const res = await axios.post("https://smarttrack-backend-oo3q.onrender.com/api/users/reset-password", {
        email,
        otp,
  ...
  const handleResend = async () => {
    ...
    try {
      const res = await axios.post("https://smarttrack-backend-oo3q.onrender.com/api/users/forgot-password", { email });
